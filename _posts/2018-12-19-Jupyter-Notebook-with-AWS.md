...
4. 작성에 도움을 주신 Alan Khang님, YoonkyungKim님 감사합니다 :-)
...
![EC2]({{ site.baseurl }}/images/photo/aws_photo_04.png)

![EC2_2]({{ site.baseurl }}/images/photo/aws_photo_05.png)
...
![인스턴스표시]({{ site.baseurl }}/images/photo/aws_photo_06.png)
...
![실행중인 인스턴스]({{ site.baseurl }}/images/photo/aws_photo_07.png)
...
![운영체제선택]({{ site.baseurl }}/images/photo/aws_photo_08.png)
...
![모델 선택]({{ site.baseurl }}/images/photo/aws_photo_09.png)
...
![디테일확인]({{ site.baseurl }}/images/photo/aws_photo_10.png)
...
![저장공간]({{ site.baseurl }}/images/photo/aws_photo_11.png)
...
![태그]({{ site.baseurl }}/images/photo/aws_photo_12.png)





내가 빌린 컴퓨터의 port를 설정합니다. 기본으로 설정된 22번 포트는 외부에서 본 컴퓨터로 접속할 수 있도록 문을 열어두는 것입니다. 이 security group의 이름을 지정하는데, `launch-wizard-1`는 aws에서 임의로 설정한 이름입니다. 저는 soryeongk 혹은 dataitgirls와 같은 이름으로 하였지만, “SSH and Mosh”, “HTTP and HTTPS”와 같이 의미있는 이름을 짓는 것이 좋습니다.

![security group]({{ site.baseurl }}/images/photo/aws_photo_13.png)
...
![adding rule]({{ site.baseurl }}/images/photo/aws_photo_14.png)
...
![영수증]({{ site.baseurl }}/images/photo/aws_photo_15.png)
...
![key pair]({{ site.baseurl }}/images/photo/aws_photo_16.png)





![완료]({{ site.baseurl }}/images/photo/aws_photo_17.png)
...
![mv .pem file]({{ site.baseurl }}/images/photo/gitbash_01.png)
...
![chmod 400]({{ site.baseurl }}/images/photo/gitbash_02.png)
...
![IP주소]({{ site.baseurl }}/images/photo/aws_photo_18.png)
...
![접속]({{ site.baseurl }}/images/photo/gitbash_03.png)

![yes를 입력]({{ site.baseurl }}/images/photo/gitbash_04.png)
...
![접속 화면]({{ site.baseurl }}/images/photo/gitbash_05.png)
...
![1]({{ site.baseurl }}/images/photo/gitbash_06.png)

이번에는 비밀번호를 입력하도록 이야기합니다. 원한다면 비밀번호를 설정해두셔도 좋습니다. 비밀번호를 설정하지 않으실 분들은 엔터를 치세요. 참고로 비밀번호를 입력해도 화면에는 출력되지 않습니다.

![2]({{ site.baseurl }}/images/photo/gitbash_07.png)

그다음 안내문구는 비밀번호 확인하는 메세지입니다.

![3]({{ site.baseurl }}/images/photo/gitbash_08.png)

여기까지 입력하면 공개키 생성이 완료됩니다. [RSA 4096]이라고 적힌 어떤 그림이 나오는데 우리들의 공개키를 예쁘게 보여주는 것입니다. 깜찍하죠.

![4]({{ site.baseurl }}/images/photo/gitbash_09.png)

그 다음에는 아래 명령어를 차례로 입력하세요.

`eval "$(ssh-agent -s)"`

![eval]({{ site.baseurl }}/images/photo/gitbash_10.png)

`ssh-add ~/.ssh/id_rsa`

![id_rsa]({{ site.baseurl }}/images/photo/gitbash_11.png)
...
![cat pub]({{ site.baseurl }}/images/photo/gitbash_12.png)
...
![github ssh]({{ site.baseurl }}/images/photo/github_01.png)
...
![ssh]({{ site.baseurl }}/images/photo/github_02.png)
...
![update]({{ site.baseurl }}/images/photo/ubuntu_01.png)
...
![docker.io]({{ site.baseurl }}/images/photo/ubuntu_02.png)
...
![token]({{ site.baseurl }}/images/photo/ubuntu_03.png)
...
![브라우저1]({{ site.baseurl }}/images/photo/ubuntu_04.png)
...
![브라우저2]({{ site.baseurl }}/images/photo/ubuntu_05.png)
...
![주피터]({{ site.baseurl }}/images/photo/ubuntu_06.png)
