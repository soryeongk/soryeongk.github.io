  ...
  return (
    <div className="px-4 pb-3 bg-gray-100 w-full">
      <ul className="flex flex-col gap-y-[1px] w-full bg-blue">
        ...
        />
        <ProjectListItem
          date={{ from: new Date("2021-07-01"), to: new Date("2021-10-31") }}
        ...
        />
        <ProjectListItem
          date={{ from: new Date("2021-06-26"), to: new Date("2021-08-31") }}
        ...
        />
        <ProjectListItem
          date={{ from: new Date("2020-08-31"), to: new Date("2020.10-17") }}
